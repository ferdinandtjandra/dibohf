...
<div class="article_pagetitle">
    <h2 id="article_pagetitle_h2">BLOG</h2>
</div>
...
<div class="article_btn">
    <?php previous_post_link('%link', '<div class="pre_btn"><div class="button_arrow"><img src="'.get_template_directory_uri().'/static/img/prearrow.png" alt=""></div><p>PREV BLOG</p></div>'); ?>
    ...
    <?php next_post_link('%link', '<div class="next_btn"><p>NEXT BLOG</p><div class="button_arrow"><img src="'.get_template_directory_uri().'/static/img/nextarrow.png" alt=""></div></div>'); ?>
</div>
<!-- article_button-->
